...
|-------------------|------|---|
| Day1 | <li>UNIX/Python</li><li>FASTQ/Hi-C quality before mapping </li><li>Iterative vs Fragment-based mapping </li><li>Stats for quality measure of Hi-C experiment </li><li>Applied filters in reads </li><li>Reading TADbit Hi-C map </li>| <dt> 4.3 </dt> <dt> 3.8 </dt><dt> 4.4 </dt><dt> 3.3 </dt><dt> 3.1 </dt><dt> 3.6 </dt>
