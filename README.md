...
|-------------------|------|---|
| Day1 | <li>UNIX/Python</li><li>FASTQ/Hi-C quality before mapping </li><li>Iterative vs Fragment-based mapping </li><li>Stats for quality measure of Hi-C experiment </li><li>Applied filters in reads </li><li>Reading TADbit Hi-C map </li>| <dd> 4.3 </dd> <dd> 3.8 </dd><dd> 4.4 </dd><dd> 3.3 </dd><dd> 3.1 </dd><dd> 3.6 </dd>
